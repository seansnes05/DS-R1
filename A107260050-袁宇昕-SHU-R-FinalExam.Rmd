...
prob.ar <- 0
prob.ar = choose(4,2)*(2/8)^2*(3/8)^2
print(prob.ar)

pmob.aw <- 0
pmob.aw <-(choose(5,2)* choose(3,2))/ choose(8,4)
print(pmob.aw)
...
set.seed(123456)
t(replicate(10, Draw_Ball.Ar()))
t(replicate(10, Draw_Ball.Aw()))
